...
print("\nMost active contributors for tensorflow AI:")
get_most_active_contributors("tensorflow", "tensorflow")

# Example usage for the OpenAI project
print("\nMost active contributors for the OpenAI project:")
get_most_active_contributors("openai", "openai-cookbook")
